...
<tr>
    <td align="right" width="40%"><span class="adm-required-field"><?= Loc::getMessage('SMS4B_MAIN_BPMA_PD_TO') ?>:</span></td>
    <td width="60%">
...
<tr>
    <td align="right" width="40%"><span class="adm-required-field"><?= Loc::getMessage('SMS4B_MAIN_BPMA_PD_PROP') ?>:</span></td>
    <td width="60%">
        <select name="user_property_phone">
            <option value=""><?= Loc::getMessage('SMS4B_MAIN_NOT_DETERMINED') ?></option>
            <? foreach ($arCurrentValues['UserPhone'] as $index): ?>
                <option
