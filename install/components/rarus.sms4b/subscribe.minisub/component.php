...
else
{
	...
	//Прячем warning подключения к сервису RSS-рассылок в 1й раз (эти параметры настроены
	//по-умолчанию и их впоследствии должен настроить клиент, а new XMLReader() не умеет
	//корректно обрабатывать такие ситуации и шлет warning)
	//@TODO - решить, поддерживаем ли мы в дальнейшем RSS. Если да - переделать
